 ...
 */
public abstract class Character extends GameObject<Character> {
    protected int size,
        maxHealth,
    ...
    protected ArrayList<Weapon> weapons;  // list of character available weapons
    protected Weapon equipedWeapon;  // weapon being currently held by the character
    protected Direction direction;  // direction the character is facing

    public Character(int size, int maxHealth, int hitsPerTimeUnit, int cost, int unlockLevel, int moveSteps, String spriteState, HashMap<Integer, SpriteSet> spriteSets, ArrayList<Weapon> weapons, Weapon equipedWeapon, Direction direction, String name, int damage, int level, int x, int y) {
